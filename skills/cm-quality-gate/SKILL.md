...
description: Use before commit/push/PR, before marking a TASK as DONE, or before saying "done". Runs the project's tests/lint/typecheck/build; refuses "done" on any failure.
---
